  ...
  <body>
      ...
      <div class="jumbotron">
		...
		<div id="navbar" class="navbar-collapse collapse">
		  <ul class="nav navbar-nav">
		    ...
		    <li class="active"><a href="manage_publishers.php">Manage Publishers</a></li>
    ...
    <div id="navbar" style="margin-top:10px">
		  <ul class="nav navbar-nav" id="manage_books">
		    <li ><a href="addPublisher.php">Add Publishers</a></li>
		  </ul>
	...
	<form action="addPublisher.php" method="post">
	 	Add Publisher ID: <input type="text" name="pub_id"><br>
		Add Publisher Name: <input type="text" name="name"><br>
		
		
	<input type="submit" value="Add Publisher" name = "submit">
	</form>
        <?php


		if(isset($_POST['submit'])){
			$sql_b=" INSERT INTO `publisher`(pub_id,name=) VALUES ('".$_POST['pub_id']."', '".$_POST['name']."')";
