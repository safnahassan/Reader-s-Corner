...
<table id = "result_table">
		...
		<tr>
	  	...
	  	<?php
			$sql="SELECT books.name,publisher.name as publisher FROM books, publisher, published_by WHERE books.ISBN=published_by.ISBN AND published_by.pub_id=publisher.pub_id";
