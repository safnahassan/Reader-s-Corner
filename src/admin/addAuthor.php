...
<html lang="en">
  ...
  <body>
	...
	<form action="addAuthor.php" method="post">
	 	Add Author ID: <input type="text" name="author_id"><br>
		Add Author Name: <input type="text" name="name"><br>
	...
	<input type="submit" value="Add Author" name = "submit">
		...
		if(isset($_POST['submit'])){
			$sql_b=" INSERT INTO `author`(author_id,name) VALUES ('".$_POST['author_id']."', '".$_POST['name']."')";
