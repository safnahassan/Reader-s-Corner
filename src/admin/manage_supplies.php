...
<table id = "result_table">
		...
		<tr>
	  	...
	  	<?php
			$sql="SELECT books.name,supplier.name as supplier, supply.in_out_stock FROM books, supply,supplier WHERE books.ISBN=supply.ISBN AND supply.sup_id=supplier.sup_id";
			...
			while($res=mysqli_fetch_array($q, MYSQLI_ASSOC)){
				?>
					...
					<td><?php echo $res['in_out_stock'];?></td>
